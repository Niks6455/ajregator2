    ...
    if(flagConfirm === false){
        ...
        return(
            ...
            <main>
                ...
                <br/>
                <br/>
                {/* <Link to="SelectTime"><ButtonSendingData/> </Link> */}
                        ...
                        {flagCalendar === true? 
                            <div>
                                <div className="calendar__box"> 
                                    ...
                                    <div>
                                    <Link to="SelectTime"><ButtonSendingData flagCalendarActivate={flagCalendarActivate} dataActiveInTitle={dataActiveInTitle} /> </Link>
                                    </div>  
                            </div> 
